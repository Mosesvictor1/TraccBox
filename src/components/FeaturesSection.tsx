...
const features = [
  ...
  },
  {
    ...
    icon: Activity,
    description: 'Set minimum order quantity based on sales trends to avoid Overstocking.'
  },
  {
...
const FeaturesSection = () => {
  return (
    <section id="features" className="py-20 bg-traccbox-500 relative overflow-hidden">
      <ThreeDBackground className="opacity-100" />
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-white">Powerful Features for Field Sales Teams</h2>

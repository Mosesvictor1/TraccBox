                  ...
                  <div className="w-2/3">
                    <div className="bg-gradient-to-br from-slate-50 to-white p-3 rounded-lg shadow-md">
                      <div className="flex justify-between items-center mb-3">
                        <div className="text-sm font-semibold text-traccbox-700">Today's Performance</div>
                        <div className="text-xs text-gray-500">May 19, 2025</div>
                      </div>
                      
                      {/* Stats */}
                      <div className="grid grid-cols-2 gap-2 mb-4">
                        <div className="bg-traccbox-50 p-2 rounded">
                          <div className="text-xs text-gray-600">Sales Completed</div>
                          <div className="text-lg font-bold text-traccbox-700">24</div>
                        </div>
                        <div className="bg-traccbox-50 p-2 rounded">
                          <div className="text-xs text-gray-600">Conversion Rate</div>
                          <div className="text-lg font-bold text-traccbox-700">68%</div>
                        </div>
                      </div>
                      
                      {/* Chart placeholder */}
                      <div className="h-16 bg-gradient-to-r from-traccbox-100 to-traccbox-200 rounded-md mb-2 relative overflow-hidden">
                        <div className="absolute bottom-0 left-0 w-full h-8">
                          <div className="w-full h-full bg-gradient-to-r from-traccbox-500/20 to-traccbox-300/20 mask-wave"></div>
                        </div>
                      </div>
                      
                      <div className="text-xs text-gray-500 text-center">Weekly Performance Trend</div>
                    </div>
                  </div>
                </div>
              </div>

      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2">
            <div
              className="bg-gradient-to-br from-traccbox-500 to-traccbox-700 p-8 text-white"
              data-aos="zoom-in"
            >
              ...
              <p className="mb-6 opacity-90">
                See how TraccBox can transform your field sales operations with
                a personalized demo from our product specialists.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start">
                  ...
                  <p>
                    Learn how TraccBox adapts to your specific sales process
                  </p>
                </div>
              ...
              <div className="bg-white/10 p-4 rounded-lg">
                <p className="text-sm opacity-80">
                  "The demo was tailored to our industry's needs and showed us
                  exactly how TraccBox would solve our specific challenges."
                </p>
                <p className="font-medium mt-2">
                  — Victor Moses, Sales Director
                </p>
              </div>
            </div>

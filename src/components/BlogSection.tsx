    ...
    <section id="blog" className="py-20">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-2">Sales Resources & Tips</h2>
            <p className="text-gray-600">Stay updated with the latest insights on field sales management.</p>
          </div>
          <div className="mt-4 md:mt-0">
            <Button variant="outline" className="border-traccbox-500 text-traccbox-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow duration-300 border-gray-200 h-full flex flex-col">
              ...
              <CardFooter>
                <Button variant="ghost" className="text-traccbox-500 p-0 hover:bg-transparent hover:text-traccbox-600">

...
const steps = [
  {
    ...
    title: "Company Setup",
    description:
      "Set up your company profile, branding, and basic configurations.",
    icon: Building,
  ...
  },
  {
    ...
    title: "Add Reps",
    description:
      "Invite your sales representatives and assign their roles and territories.",
    icon: Users,
  ...
  },
  {
    ...
    title: "Assign Tasks",
    description:
      "Create tasks and assign them to your team members based on priorities.",
    icon: ListCheck,
  ...
  },
  {
    ...
    title: "Go Live",
    description:
      "Start tracking performances, collecting data, and optimizing your sales process.",
    icon: Rocket,
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto" data-aos="fade-up">
            Get up and running in minutes with our straightforward onboarding
            process.
          </p>
        </div>
          ...
          <div className="relative">
            ...
            <div className="space-y-12 md:space-y-0">
              {steps.map((step, index) => (
                <div
                  key={index}
                  className={`flex flex-col md:flex-row md:mb-24 ${
                    index % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"
                  }`}
                  data-aos="zoom-in"
                  data-aos-delay={`${(step.number % 3) * 100}`}
                >
                      ...
                      <div className="mt-4">
                        ...
                        {index === 1 && (
                          <div className="flex space-x-2">
                            ...
                            <div className="w-8 h-8 bg-gray-200 rounded-full"></div>
                            <div className="w-8 h-8 bg-traccbox-500 rounded-full flex items-center justify-center text-white text-xs">
                              +
                            </div>
                          </div>
                        )}
